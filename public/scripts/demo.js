(function(){
    $.ajax({
        url : 'https://app.dipendo.com/api/sale-items?productId=0&groupId=0&status=3&saleId=0&offset=0&limit=100&startTime=&endTime=2022-06-29T21:00:00.007Z&view=Shipped',
        headers : {
...
function getRowHTML(item){
    ...
    <div class="col-2">${dt.getDate()}.${dt.getMonth()+1}.${dt.getFullYear()}</div>
